        ...
        <div class="max-w-md mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form x-ref="form" method="POST" action="{{ route('admin.files.store') }}"
                        enctype="multipart/form-data">
                        @csrf

                        <!-- Title Field -->
                        <div>
                            <label for="title" class="block font-medium text-sm text-gray-700">File Title</label>
                            <input type="text" name="title" id="title" class="block mt-1 w-full"
                                x-model="title" autofocus>
                            <span class="text-red-500 text-xs" x-text="titleError"></span>
                        </div>

                        <!-- Folder Selection -->
                        <div class="mt-4">
                            <label for="folder_id"
                                class="block font-medium text-sm text-gray-700">{{ __('Folder') }}</label>
                        ...
                        <div class="mt-4">
                            <label for="path"
                                class="block font-medium text-sm text-gray-700">{{ __('File') }}</label>
